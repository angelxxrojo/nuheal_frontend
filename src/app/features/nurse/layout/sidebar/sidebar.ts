...
@Component({
  ...
  template: `
    ...
    <aside
      ...
      class="fixed inset-y-0 left-0 z-30 flex flex-col bg-gray-900 transition-all duration-300 lg:relative lg:translate-x-0"
    >
      <!-- Logo -->
      <div class="flex items-center justify-between h-16 px-4 bg-gray-800">
        <a routerLink="/nurse/dashboard" class="flex items-center space-x-2">
          ...
          @for (item of menuItems; track item.route) {
            <li>
              <a
                ...
                class="flex items-center px-4 py-2.5 text-gray-300 hover:bg-gray-800 hover:text-white rounded-lg transition-colors"
